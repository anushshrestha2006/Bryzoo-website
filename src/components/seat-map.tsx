        ...
        <AlertDialogContent>
          ...
          <AlertDialogFooter>
            ...
            <Button variant="outline" asChild>
              <Link href={`/signup?redirect=/booking&${searchParams.toString()}&seats=${selectedSeats.join(',')}`}>Sign Up</Link>
            </Button>
            <AlertDialogAction asChild>
                <Link href={`/login?redirect=/booking&${searchParams.toString()}&seats=${selectedSeats.join(',')}`}>Login</Link>
            </AlertDialogAction>
          </AlertDialogFooter>
        </AlertDialogContent>
      </AlertDialog>
